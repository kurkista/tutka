...
// than an assumed one.
import { SOCIAL, DEVIATION_MONTHLY, DEVIATION_DAILY } from '../config.js';
...
const social = makeDomainIndex({
  ...
  config: SOCIAL,
  components: [
    { key: 'V', metric: 'gdelt_social_vol_daily', direction: 'high', zeroIsMissing: true, tuning: DEVIATION_DAILY },
